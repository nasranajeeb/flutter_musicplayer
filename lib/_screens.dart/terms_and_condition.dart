...
class TermsAndConditions extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          padding: EdgeInsets.only(
              ...
              top: mediaqueryHeight(0.06, context)),
          child: Column(
            ...
            children: [
              Row(
                children: [
                  ...
                  myText("Terms & Conditions", mediaqueryHeight(0.025, context),
                      greyColor),
                ],
              ),
              SizedBox(
  ...
  final String termsText = '''Last updated December 27, 2023

AGREEMENT TO OUR LEGAL TERMS

We operate the mobile application lazits (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").

We provide you with a music player in which you will be able to hear songs from your internal storage and also record your voice and hear it later with so much additional features

You can contact us by phone at 9961628586, email at shahamahammed66@gmail.com, or by mail to marhaba, , chaliyam, calicut, kerala 673301, India.
